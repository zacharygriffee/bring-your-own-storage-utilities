...
class Subscription{constructor(i){this.initialTeardown=i,this.closed=!1,this._parentage=null,this._finalizers=null;}unsubscribe(){let t;if(!this.closed){this.closed=!0;const{_parentage:n}=this;if(n)if(this._parentage=null,Array.isArray(n))for(const i of n)i.remove(this);else n.remove(this);const{initialTeardown:e}=this;if(isFunction(e))try{e();}catch(i){t=i instanceof UnsubscriptionError?i.errors:[i];}const{_finalizers:o}=this;if(o){this._finalizers=null;for(const i of o)try{s$v(i);}catch(i){t=null!=t?t:[],i instanceof UnsubscriptionError?t=[...t,...i.errors]:t.push(i);}}if(t)throw new UnsubscriptionError(t)}}add(i){var r;if(i&&i!==this)if(this.closed)s$v(i);else {if(i instanceof Subscription){if(i.closed||i._hasParent(this))return;i._addParent(this);}(this._finalizers=null!==(r=this._finalizers)&&void 0!==r?r:[]).push(i);}}_hasParent(i){const{_parentage:r}=this;return r===i||Array.isArray(r)&&r.includes(i)}_addParent(i){const{_parentage:r}=this;this._parentage=Array.isArray(r)?(r.push(i),r):r?[r,i]:i;}_removeParent(i){const{_parentage:r}=this;r===i?this._parentage=null:Array.isArray(r)&&arrRemove(r,i);}remove(i){const{_finalizers:r}=this;r&&arrRemove(r,i),i instanceof Subscription&&i._removeParent(this);}}Subscription.EMPTY=(()=>{const i=new Subscription;return i.closed=!0,i})();const EMPTY_SUBSCRIPTION=Subscription.EMPTY;function isSubscription(r){return r instanceof Subscription||r&&"closed"in r&&isFunction(r.remove)&&isFunction(r.add)&&isFunction(r.unsubscribe)}function s$v(r){isFunction(r)?r():r.unsubscribe();}
...
let e$2o,t$2t=1;const n$1k={};function o$1M(e){return e in n$1k&&(delete n$1k[e],!0)}const Immediate={setImmediate(s){const r=t$2t++;return n$1k[r]=!0,e$2o||(e$2o=Promise.resolve()),e$2o.then((()=>o$1M(r)&&s())),r},clearImmediate(e){o$1M(e);}};

const{setImmediate:t$2s,clearImmediate:m$B}=Immediate;const immediateProvider={setImmediate(...e){const{delegate:m}=immediateProvider;return ((null==m?void 0:m.setImmediate)||t$2s)(...e)},clearImmediate(e){const{delegate:t}=immediateProvider;return ((null==t?void 0:t.clearImmediate)||m$B)(e)},delegate:void 0};
...
function e$2n(o){return o[o.length-1]}function popResultSelector(r){return isFunction(e$2n(r))?r.pop():void 0}function popScheduler(o){return isScheduler(e$2n(o))?o.pop():void 0}function popNumber(o,r){return "number"==typeof e$2n(o)?o.pop():r}
...
function firstValueFrom(o,t){const n="object"==typeof t;return new Promise(((u,i)=>{const s=new SafeSubscriber({next:r=>{u(r),s.unsubscribe();},error:i,complete:()=>{n?u(t.defaultValue):i(new EmptyError);}});o.subscribe(s);}))}
...
function catchError(b){return operate(((o,u)=>{let e,s=null,t=!1;s=o.subscribe(createOperatorSubscriber(u,void 0,void 0,(i=>{e=innerFrom(b(i,catchError(b)(o))),s?(s.unsubscribe(),s=null,e.subscribe(u)):t=!0;}))),t&&(s.unsubscribe(),s=null,e.subscribe(u));}))}
...
const o$1L=(r,t)=>(r.push(t),r);function toArray(){return operate(((t,i)=>{reduce(o$1L,[])(t).subscribe(i);}))}
...
const n$1j={connector:()=>new Subject};function connect(o,c=n$1j){const{connector:b}=c;return operate(((t,n)=>{const c=b();innerFrom(o(fromSubscribable(c))).subscribe(n),n.add(t.subscribe(c));}))}
...
function distinctUntilChanged(o,e=identity){return o=null!=o?o:n$1i,operate(((t,r)=>{let n,u=!0;t.subscribe(createOperatorSubscriber(r,(t=>{const i=e(t);!u&&o(n,i)||(u=!1,n=i,r.next(t));})));}))}function n$1i(t,r){return t===r}

function throwIfEmpty(r=e$2m){return operate(((t,e)=>{let i=!1;t.subscribe(createOperatorSubscriber(e,(r=>{i=!0,e.next(r);}),(()=>i?e.complete():e.error(r()))));}))}function e$2m(){return new EmptyError}
...
function expand(o,e=1/0,i){return e=(e||0)<1?1/0:e,operate(((r,n)=>mergeInternals(r,n,o,e,void 0,!0,i)))}

function finalize(r){return operate(((i,t)=>{try{i.subscribe(t);}finally{t.add(r);}}))}

function find(t,r){return operate(createFind(t,r,"value"))}function createFind(e,r,n){const o="index"===n;return (n,i)=>{let c=0;n.subscribe(createOperatorSubscriber(i,(t=>{const l=c++;e.call(r,t,l,n)&&(i.next(o?l:t),i.complete());}),(()=>{i.next(o?-1:void 0),i.complete();})));}}
...
const i$M={map:e$21,isString:e$20};function traverseDownDirectory$(s,e={}){i$M.isString(e)&&(e={cwd:e});const{isFolderSelector:a=(r=>!i$U.extname(r)),readdir$:m=((t,o)=>from(t.readdir(o))),cwd:p="/"}=e;return Qe({factory:(o=p)=>from(m(s,o)).pipe(map((r=>{const s=a(r),e=i$U.resolve(o,r);return {markers:s?[e]:[],values:[e]}})))}).pipe(startWith(p))}
...
var e$1V=function(o){const e=m$r,t=r$1t;return o.map(t.dirname).map((o=>o.split(t.sep))).reduce(e).concat([""]).join(t.sep)};var n$_ = getDefaultExportFromCjs(e$1V);
...
function isRelative(r){return m$q(r,"../")||m$q(r,"./")}

function isAbsolute(s){return m$q(s,"/")}

function isRootFolder(o="/"){return "/"===o||""===o}

function isFile$(o,e){if(isRootFolder(e))return of(!0);const t=(o.exists||o.entry).bind(o);return defer((()=>t(e))).pipe(map((r=>!!r)),catchError((()=>of(!1))))}

function isFolder$(e,f){return isRootFolder(f)?of(!0):isFile$(e,f).pipe(switchMap((o=>o?of(!1):readdir$(e,{cwd:f}).pipe(first(),map((()=>!0))))),catchError((()=>of(!1))))}
...
const{concatIfEmpty:i$B}=_t$1;function getType$(r,o,n={}){return createReadStream$(r,o,{wait:!1,...n,start:0,end:99}).pipe(map((e=>e.length>30?f$n(e):[p$b(o)??null])),filter$1((t=>t.length)),map((([t])=>t)),i$B(defer((()=>of(p$b(o))))),catchError((t=>of(null))))}function p$b(t){const e=i$U.extname(t)?.toLowerCase();return mimeTypes.find((({extension:t})=>t===e))?.mimeType}

function pathDetail$(t,p){return Ye({isFolder:isFolder$(t,p),isFile:isFile$(t,p),type:getType$(t,p)})}

function getEntry$(t,i,l={}){const{cwd:p="/",entrySelector:u=a$S}=l;return isAbsolute(i)||(i=i$U.resolve(i,p)),from(u(t,i,l)).pipe(filter$1((t=>!!t)),mergeMap((o=>pathDetail$(t,i).pipe(map((t=>({key:i,...o,...t})))))))}async function a$S(e,r,o){const n=e.get?.bind(e),a=e.entry?.bind(e);let i={};if(n||a){const e=await(a||n)(r,o);return e?(a?i=e:(i.value={},i.value.blob={},i.value.blob.byteLength=t$1K.from(e)?.byteLength||0,i.value.blob.byteOffset=0,i.value.executable=!1,i.value.metadata=null),i):{}}return i}
...
async function findDown(o,t,e={}){return firstValueFrom(findDown$(o,t,e))}function findDown$(o,t,e={}){const{count:i=1}=e;return findDownMultiple$(o,t,e).pipe(concatMap((r=>r.flat())),take(i),toArray(),defaultIfEmpty(null))}function findDownMultiple$(u,c,h={}){let I,{maxLevel:j=Number.POSITIVE_INFINITY,minLevel:y=0,count:w=Number.POSITIVE_INFINITY,filter:x,cwd:D="/"}=h;return c=e$21(t$1J(c),(r=>r=toPath(r))),I=a$Q(c,(r=>!isAbsolute(r)))?D:e$1W(i$U.dirname(n$_(c))),traverseDownDirectory$(u,{...h,cwd:"."===I?"/":I}).pipe(filter$1((r=>!!o$1a(c,(o=>minimatch(r,isAbsolute(o)||isRelative(o)?i$U.resolve(D,o):"/**/"+o,{matchBase:!0}))))),x?filter$1(x):identity,take(w),takeWhile(((r,o)=>o<=j)),map((r=>[r,i$U.dirname(r).split("/").length-1])),reduce(((r,[o,t])=>{if(t>=y&&t<j){for(let o=0;o<=t;o++)r[o]||=[];r[t].push(o);}return r}),[]))}
...
const e$1M={map:e$21,isString:e$20,isEmpty:n$S};function traverseUpDirectory$(o,i="/",m={}){!e$1M.isString(i)&&e$1M.isEmpty(m)&&(m=i,i="/");const{readdir$:a=((t,s)=>from(t.readdir(s))),cwd:p}=m;let n=!0;return Qe({factory:(t=i||p)=>from(a(o,t)).pipe(toArray(),map((r=>{const o=i$U.dirname(t)||"/";try{return {markers:o&&"."!==t&&n?[o]:[],values:e$1M.map(r,(r=>i$U.resolve(t,r)))}}finally{n=!("/"===o);}})))}).pipe(startWith("/"))}

async function findUp(r,t,e,o={}){return firstValueFrom(findUp$(...arguments))}function findUp$(r,t,e,o={}){return findUpMultiple$(r,t,e,o).pipe(concatMap((r=>r.flat())),toArray(),defaultIfEmpty(null))}function findUpMultiple$(l,a,u,d={}){!u||e$20(u)||arguments[3]||(d=u,u=null),a=t$1J(a);const{cwd:c=u||n$_(a),maxLevel:I=Number.POSITIVE_INFINITY,minLevel:y=0,count:h=Number.POSITIVE_INFINITY,filter:j}=d;return d.cwd=c,traverseUpDirectory$(l,c,d).pipe(filter$1((e=>!!o$1a(a,(i=>minimatch(e,isAbsolute(i)||isRelative(i)?i$U.resolve(c,i):"/**/"+i,{matchBase:!0}))))),j?filter$1(j):identity,take(h),map((r=>[r,i$U.dirname(r).split("/").length-1])),reduce(((r,[t,e])=>{if(e>=y&&e<I){for(let t=0;t<=e;t++)r[t]||=[];r[e].push(t);}return r}),[]))}
...
function findNodeModulesDirectory$(r,e={}){return findUp$(r,"node_modules",void 0,e)}async function findNodeModulesDirectory(o,e={}){return firstValueFrom(findNodeModulesDirectory$(o,e))}

function readdir$(o,a={}){e$20(a)&&(a={cwd:a});let d,{cwd:n,list:m=!1,recursive:l=m,trimPath:p=!0}=a;if(o.list||o.readdir){const t=(m?o.list:o.readdir)?.bind(o);m&&!o.list&&o.readdir?(a.recursive=!0,d=from(o.readdir(n,a)).pipe(mergeMap((r=>getEntry$(o,r,a))))):d=defer((()=>t(n,a)));}else if(function(r){return r.sub&&r.batch&&r.createHistoryStream}(o)){const{range:e,limit:t,reverse:f}=a,c=o.snapshot();d=from(c.createReadStream(e,{limit:t,reverse:f})).pipe(map((r=>m?r:r.key)),filter$1((r=>{let e=m?r.key:r;if(e=p?f$3(e,"./"):e,m$q(e,n?n+"/":"")){const r=n?.length||0;return !!l||e.slice(r>0?r+1:0).split("/").length<=1}return !1})));}return d}async function readdir(e,t={}){return firstValueFrom(readdir$(e,t).pipe(toArray()))}

const c$1=()=>filter$1((o=>null!=o));function findNodeModule$(e,n,p={}){return findNodeModulesDirectory$(e,p).pipe(concatMap((e=>from(e$21(t$1J(n),(r=>{if(r.indexOf("/")>-1){const[o,t]=r.split("/");(r=o).startsWith("@")&&(r+="/"+t);}return e$21(e.flat(),(t=>i$U.join(t,r)))}))))),filter$1((o=>!!o&&!!o.length)),concatAll(),concatMap((o=>readdir$(e,{cwd:o}).pipe(find((o=>"package.json"===o)),map((r=>r&&o||null)),c$1()))))}async function findNodeModule(o,r,t){return firstValueFrom(findNodeModule$(o,r,t).pipe(toArray(),defaultIfEmpty([])))}

function findPackageJson$(n,o={}){return findUpMultiple$(n,"package.json",o).pipe(map((n=>n.flat()||void 0)))}async function findPackageJson(r,e={}){return firstValueFrom(findPackageJson$(r,e).pipe(toArray(),map((n=>n.flat())),defaultIfEmpty(null)))}

function findPackageDirectory$(i,e={}){return findPackageJson$(i,e).pipe(concatAll(),map(i$U.dirname),map((r=>r||"/")))}async function findPackageDirectory(r,o={}){return firstValueFrom(findPackageDirectory$(r,o).pipe(take(1),defaultIfEmpty([])))}

function parseModuleSpecifier(n,m={}){let{host:r,version:a="",path:h="",type:$="",mapPath:d}=m;if(m$q(f$3(n,"/."),"node_modules")){const s=f$3(n,"/.").split("/");s.shift(),n=s.join("/");}null===a&&(a="");const f=a;let j,c,u="",g="";if($&&(m$q(n,`/${$}/`)&&(n=n.slice(`/${$}/`.length)),m$q(n,`${$}/`)&&(n=n.slice(`${$}/`.length)),i$l(n,"/+esm")&&(n=n.slice(0,-5))),m$q(n,"@")?([,n,a=a]=n.split("@",3),[a=a,...j]=a.split("/"),[g,n,...c]=n.split("/")):([n,a=a]=n.split("@",2),[a=a,...j]=a.split("/"),[n,...c]=n.split("/")),!f$3(n,"./"))return null;if(j.length>0&&c.length>0)debugger;h?u=h:j.length>0?u=j.join("/"):c.length>0&&(u=c.join("/")),a=f||a;const y=`${g?"@"+g+"/":""}${n}${a?"@"+a:""}`,v=""+(u?"/"+n$1m(u,"/"):"");let x=[`${y}${v}`];if(v){i$U.extname(v)||m$d([".js",".cjs",".mjs",".json","/"],(s=>{let t=`${y}${v}${s}`;x.push(t);}));}return r&&(x=e$21(x,(s=>`${r}${$?"/"+$:""}/${s}`))),d&&(x=x.map(d)),{nodeModulesPath:`node_modules/${y}`,type:$,path:`/${y}${v}`,pathName:v,namespace:g,scope:g,version:a,module:`${y}`,name:n,paths:x}}

const t=t=>null!==t&&"object"==typeof t,e=(t,e)=>Object.assign(new Error(`[${t}]: ${e}`),{code:t}),r="ERR_INVALID_PACKAGE_CONFIG",n="ERR_INVALID_PACKAGE_TARGET",o=/^\d+$/,i=/^(\.{1,2}|node_modules)$/i,s=/\/|\\/;var a,c=((a=c||{}).Export="exports",a.Import="imports",a);const f=(a,c,d,p,l)=>{if(null==c)return [];if("string"==typeof c){const[t,...r]=c.split(s);if(".."===t||r.some((t=>i.test(t))))throw e(n,`Invalid "${a}" target "${c}" defined in the package config`);return [l?c.replace(/\*/g,l):c]}if(Array.isArray(c))return c.flatMap((t=>f(a,t,d,p,l)));if(t(c)){for(const t of Object.keys(c)){if(o.test(t))throw e(r,"Cannot contain numeric property keys");if("default"===t||p.includes(t))return f(a,c[t],d,p,l)}return []}throw e(n,`Invalid "${a}" target "${c}"`)},d="*",p=(t,e)=>{const r=t.indexOf(d),n=e.indexOf(d);return r===n?e.length>t.length:n>r};function l(t,e){if(!e.includes(d)&&t.hasOwnProperty(e))return [e];let r,n;for(const o of Object.keys(t))if(o.includes(d)){const[t,i,s]=o.split(d);if(void 0===s&&e.startsWith(t)&&e.endsWith(i)){const s=e.slice(t.length,-i.length||void 0);s&&(!r||p(r,o))&&(r=o,n=s);}}return [r,n]}const u=/^\w+:/,h=(o,i,s)=>{if(!o)throw new Error('"exports" is required');i=""===i?".":`./${i}`,("string"==typeof o||Array.isArray(o)||t(o)&&(t=>Object.keys(t).reduce(((t,n)=>{const o=""===n||"."!==n[0];if(void 0===t||t===o)return o;throw e(r,'"exports" cannot contain some keys starting with "." and some not')}),void 0))(o))&&(o={".":o});const[a,d]=l(o,i),p=f(c.Export,o[a],i,s,d);if(0===p.length)throw e("ERR_PACKAGE_PATH_NOT_EXPORTED","."===i?'No "exports" main defined':`Package subpath '${i}' is not defined by "exports"`);for(const t of p)if(!t.startsWith("./")&&!u.test(t))throw e(n,`Invalid "exports" target "${t}" defined in the package config`);return p},g=(t,r,n)=>{if(!t)throw new Error('"imports" is required');const[o,i]=l(t,r),s=f(c.Import,t[o],r,n,i);if(0===s.length)throw e("ERR_PACKAGE_IMPORT_NOT_DEFINED",`Package import specifier "${r}" is not defined in package`);return s};

function list$(r,t={}){return e$20(t)&&(t={cwd:t}),readdir$(r,{...t,list:!0})}async function list(i,o){return firstValueFrom(list$(i,o).pipe(toArray()))}

export { coercePathAbsolute, b$7 as fileURLToPath, findDown, findDown$, findDownMultiple$, findNodeModule, findNodeModule$, findNodeModulesDirectory, findNodeModulesDirectory$, findPackageDirectory, findPackageDirectory$, findPackageJson, findPackageJson$, findUp, findUp$, findUpMultiple$, list, list$, parseModuleSpecifier, readdir, readdir$, h as resolveExports, g as resolveImports, toPath };
