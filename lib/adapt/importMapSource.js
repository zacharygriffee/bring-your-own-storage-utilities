 ...
 * @memberOf Adapt
 */
export function getImportMap(defaultMap = {imports: {}, scope: {}}, cache = true) {
 ...
 * @memberOf Adapt
 */
export function setImportMap(importMap = {imports: {}, scope: {}}) {
 ...
 * @memberOf Adapt
 */
export function importMapSource(cache = true, scope = "imports") {
            ...
            const {
                handler = async (code, config = {}) => {
                    ...
                    if (typeof pack === "function") {
                        ...
                        return pack(key, packConfig);
                    }
                    return import(code).then(o => ({module: o, key}));
                }
            } = config;
