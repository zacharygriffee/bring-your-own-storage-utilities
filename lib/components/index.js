 ...
 * @property {string} [theme=dark] - A choice between dark or light color theme
 * @property {Observable<{fullPath: string, isFolder: boolean, isFile: boolean}>} keys$ A list of keys to download. The
 * key object this observable emits should resemble the Query.pathDetail$ interface. It should at minimum have isFile,
 * fullPath, and isFolder.
 *
 */
let SaveAll;