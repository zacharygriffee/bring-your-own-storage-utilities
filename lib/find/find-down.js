 ...
 * any entry without an extension (e.g. .txt) a folder and a folder must also have at least one file somewhere as a
 * dependent of it. e.g. empty folders with no files should **not** show up.
